...
A simple browser-based script that automatically deletes your Facebook comments one by one or by bulk. It’s secure, no need to share your password or grant special permissions, and includes random delays to mimic human behavior, making it less likely to be flagged as a bot.<p />
...
- If you’re using the bulk delete script (snippet_bulk.js), run it once first, Facebook will prompt you to enter your account password. After that initial step, you can run the script normally for some time until it ask you for the password again some time later.

<p align="left">
  <img src="steps/insert_password.png" width="320">
</p>
